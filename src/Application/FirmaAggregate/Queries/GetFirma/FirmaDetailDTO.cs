...
public class FirmaDetailDTO : BaseAuditableDto
{
    ...
    public required IEnumerable<KontaktnaOsobaDTO> KontaktneOsoby { get; init; }
    public required IEnumerable<ObjednavkaDTO> Objednavky { get; init; }

    private class Mapping : Profile
    {
        public Mapping()
        {
            CreateMap< Firma, FirmaDetailDTO >();
        }
    }
}
