...
namespace CRMBackend.Application.ObjednavkaAggregate.Commands.Objednavky.CreateObjednavka
{
    ...
    public class CreateObjednavkaCommandHandler : IRequestHandler<CreateObjednavkaCommand, int>
    {
        ...
        public CreateObjednavkaCommandHandler(IWriteRepository<Objednavka> repository, IWriteRepository<Firma> firmaRepository)
        {
        ...
        {
            var firma = await _firmaRepository.GetByIdAsync(request.FirmaId, cancellationToken);
